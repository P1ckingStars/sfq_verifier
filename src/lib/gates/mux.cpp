...
Automata * MUX_GATE() {
    ...
    res->appendEdge(Edge(B_ARRIVED, B_AND_SEL_ARRIVED, SEL));
    ...
    res->appendEdge(Edge(A_AND_B_ARRIVED, B_AND_SEL_ARRIVED, SEL));
    res->appendEdge(Edge(SEL_ARRIVED, SEL_ARRIVED, SEL));
    res->appendEdge(Edge(SEL_ARRIVED, SEL_ARRIVED, A));
    res->appendEdge(Edge(SEL_ARRIVED, IDLE, CLK));
    res->appendEdge(Edge(SEL_ARRIVED, B_AND_SEL_ARRIVED, B));
    res->appendEdge(Edge(B_AND_SEL_ARRIVED, B_AND_SEL_ARRIVED, SEL));
    res->appendEdge(Edge(B_AND_SEL_ARRIVED, B_AND_SEL_ARRIVED, A));
    res->appendEdge(Edge(B_AND_SEL_ARRIVED, B_AND_SEL_ARRIVED, B));
